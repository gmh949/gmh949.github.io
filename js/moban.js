...
window.onload = function() {
  var back = document.querySelector('.main_content');
  var a = 0;
  setInterval(function() {
    if(a<360){
      back.style.backgroundImage = 'linear-gradient('+ a +'deg,#2980b9,#6dd5fa,#FFFFFF)'
      a += 1;
    }else{
      a = 0;
      // back.style.backgroundImage = 'linear-gradient('+ a +'deg,#2980B9,#2980b9,#6DD5FA,#6dd5fa,#FFFFFF)'
    }
  },20)
  console.log(back)
}